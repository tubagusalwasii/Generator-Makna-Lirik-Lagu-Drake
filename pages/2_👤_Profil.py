...
with col1:
    # Menggunakan use_container_width agar gambar memenuhi kolom
    st.image(URL_FOTO_PROFIL, caption="Aubrey 'Drake' Graham", use_container_width=True)
...
with col1_ml:
    st.image(URL_MORE_LIFE, caption="More Life - A Playlist by October Firm", use_container_width=True)
with col2_ml:
...
with col1_sc:
    st.image(URL_SCORPION, caption="Scorpion", use_container_width=True)
with col2_sc:
...
with col1_cp:
    st.image(URL_CARE_PACKAGE, caption="Care Package", use_container_width=True)
with col2_cp:
    st.markdown("**Daftar Lagu:**")
...
with col1_dl:
    st.image(URL_DARK_LANE, caption="Dark Lane Demo Tapes", use_container_width=True)
with col2_dl:
    st.markdown("**Daftar Lagu:**")
